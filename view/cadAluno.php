            ...
            <div class="cad_center">
                <div class="cad_formLyt">
                    <div class="cad_bordaAmarela">
                        ...
                        <form class="row g-3 cad_form" method="POST" action="../controller/inserirAluno.php">
                            <div class="col-md-12">
                                <label for="inputEmail4" class="form-label">Nome Completo</label>
                                <input style="text-transform: uppercase" type="text" class="form-control" name="txt_NomeClient" id="inputEmail4" placeholder="Insira seu nome completo" required>
                            </div>

                            <div class="col-md-6">
                                <label for="inputAddress" class="form-label">CPF</label>
                                <input type="text" class="form-control" maxlength="11" minlength="11" name="txt_CPF" id="cpf" placeholder="000.000.000-00" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" maxlength="11" minlength="11" name="txt_Celular" data-mask="(00) 00000-0000" data-mask-selectonfocus="true" id="cel" placeholder="(00) 00000-0000" required>
                            </div>
                            ...
                            <h3 class="cad_subtitulo"> Dados de Aluno </h3> </center>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="txt_RM" placeholder="00000" required>
                            </div>
