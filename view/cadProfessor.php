                    ...
                    <div class="cad_bordaAmarela">
                        ...
                        <form class="row g-3 cad_form" method="POST" action="../controller/inserirProfessor.php">
                            <div class="col-md-12">
                                ...
                                <input type="text" style="text-transform: uppercase" class="form-control" name="txt_NomeClient" id="inputEmail4" placeholder="Insira seu nome completo" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number"class="form-control" maxlength="11" minlength="11"  name="txt_Celular" data-mask="(00) 00000-0000" data-mask-selectonfocus="true" id="cel" placeholder="(00) 00000-0000" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" maxlength="7" minlength="5" class="form-control" name="txt_Matricula" required>
                            </div>
